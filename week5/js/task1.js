...
var task1 = {
  ...
  devInfo: function () {
    ...
    btnDev.addEventListener("click", function(){
      document.getElementById("dev-info-container").innerHTML = "<p>Chidi Kingsley<br>IT Student<br><a href='https://github.com/daddies20' target='_blank'>Github Link</a></p>"
      });
  }
}
task1.render();
